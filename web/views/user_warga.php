                ...
                <div id="collapseOne" class="collapse <?= (isset($_GET['edit'])) ? 'show' : '' ?>" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="phone_div" class="col-md-6 form-group">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h4 class="font-16 mt-0">Data Warga</h4>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($user->view_warga() as $k => $v) {
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $v['warga_name'] ?></td>
                                        <td><?= $v['username'] ?></td>
                                        <td><?= $v['warga_gender'] ?></td>
                                        <td><?= $v['warga_alamat'] ?></td>
                                        <td><?= $v['warga_phone'] ?></td>
                                        <td>
                                            <a href="home?p=user_warga&edit=<?= $v['user_id'] ?>" type="button" class="btn btn-info">Edit</a>
    ...
    function save() {
        ...
        $.ajax({
            ...
            success: function(res) {
                console.log(res)
                if (res == 1) {
                    processSuccess("Proses Berhasil", "home?p=user_warga");
                } else if (res == 2) {
